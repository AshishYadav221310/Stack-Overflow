          ...
          <div className='ask-form-container'>
            ...
            <label htmlFor="ask-ques-body">
              ...
              <p>Include all the information someone would need to answer your
                ...
                <textarea
                name=""
                id="ask-ques-body" onChange={(e) => {setQuestionBody(e.target.value)}}
            ...
            <label htmlFor="ask-ques-tags">
              ...
              <input type="text"  id='ask-ques-tags' onChange={(e) => {setQuestionTags(e.target.value.split(" "))}} placeholder='e.g is there any question' />
            </label>
          </div>
